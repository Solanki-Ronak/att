...
function addContactField(modalType = 'add', phone = '', contactId = null) {
    ...
    contactGroup.innerHTML = `
        <input type="text" class="contact-input" placeholder="Phone number (10 digits)" 
               value="${phone}" oninput="validatePhoneNumber(this)" maxlength="10">
        <button type="button" class="btn-remove-contact" onclick="removeContactField(this)">🗑️</button>
    `;
    ...
    const newInput = contactGroup.querySelector('.contact-input');
...
// UPDATED: Toggle No Driver mode with license URL clearing
function toggleNoDriverMode() {
    ...
    if (isActive) {
        ...
        // Clear the Google Drive license link
        document.getElementById('addDriverLicenseUrl').value = '';
    }
    
    // Update validation state
    updateSaveButtonState();
}
// UPDATED: Disable driver fields but preserve Google Drive link value and hide license section
function disableDriverFields() {
    ...
    // Keep the Google Drive license URL value but make it readonly
    document.getElementById('addDriverLicenseUrl').readOnly = true;
    document.getElementById('addDriverLicenseUrl').style.backgroundColor = '#f8f9fa';
    document.getElementById('addDriverLicenseUrl').style.cursor = 'not-allowed';

    // Hide the current license section (view button)
    const currentLicenseSection = document.getElementById('currentLicenseSection');
    if (currentLicenseSection) {
        currentLicenseSection.style.display = 'none';
    }
...
// UPDATED: Enable driver fields including license URL and show license section
function enableDriverFields() {
    ...
    // Enable driver license URL (Google Drive link)
    document.getElementById('addDriverLicenseUrl').readOnly = false;
    document.getElementById('addDriverLicenseUrl').style.backgroundColor = '';
    document.getElementById('addDriverLicenseUrl').style.cursor = '';
    document.getElementById('addDriverLicenseUrl').placeholder = '';

    // Show the current license section if there's a license URL
    const currentLicenseSection = document.getElementById('currentLicenseSection');
    const licenseUrl = document.getElementById('addDriverLicenseUrl').value;
    if (currentLicenseSection && licenseUrl) {
        currentLicenseSection.style.display = 'block';
        currentLicenseSection.setAttribute('data-license-url', licenseUrl);
    }
...
// UPDATED: Toggle No Driver mode for Edit modal with license URL clearing
...
// UPDATED: Disable driver fields in Edit modal but preserve Google Drive link value and hide license section
function disableEditDriverFields() {
    ...
    // Keep the Google Drive license URL value but make it readonly
    document.getElementById('editDriverLicenseUrl').readOnly = true;
    document.getElementById('editDriverLicenseUrl').style.backgroundColor = '#f8f9fa';
    document.getElementById('editDriverLicenseUrl').style.cursor = 'not-allowed';
...
// UPDATED: Enable driver fields in Edit modal including license URL and show license section
function enableEditDriverFields() {
    ...
    // Enable driver license URL (Google Drive link)
    document.getElementById('editDriverLicenseUrl').readOnly = false;
    document.getElementById('editDriverLicenseUrl').style.backgroundColor = '';
    document.getElementById('editDriverLicenseUrl').style.cursor = '';
    document.getElementById('editDriverLicenseUrl').placeholder = '';

    // Show the current license section if there's a license URL
    const currentLicenseSection = document.getElementById('currentLicenseSection');
    const licenseUrl = document.getElementById('editDriverLicenseUrl').value;
    if (currentLicenseSection && licenseUrl) {
        currentLicenseSection.style.display = 'block';
        currentLicenseSection.setAttribute('data-license-url', licenseUrl);
    }
...
// UPDATED: Enable driver fields in Edit modal including license URL
function enableEditDriverFields() {
    // Enable driver name (but don't clear the value - keep existing data)
    document.getElementById('editDriverName').readOnly = false;
    document.getElementById('editDriverName').style.backgroundColor = '';
    ...
    // Enable driver license URL (Google Drive link) - DON'T clear it, just make it editable
    document.getElementById('editDriverLicenseUrl').readOnly = false;
    document.getElementById('editDriverLicenseUrl').style.backgroundColor = '';
    document.getElementById('editDriverLicenseUrl').style.cursor = '';
    document.getElementById('editDriverLicenseUrl').placeholder = '';
...
function validatePhoneNumber(input) {
    ...
    if (value.length === 10) {
        ...
        input.style.borderColor = '#ff4444'; // Red for invalid
    }
}

document.addEventListener('DOMContentLoaded', function() {
    // Add input event listeners to all contact input fields
    ...
    // Also add to existing contact fields
    setTimeout(() => {
...
// MODIFIED: Handle driver image selection with file size validation
...
// MODIFIED: Handle truck image selection with file size validation
...
// MODIFIED: Handle additional image selection with file size validation
